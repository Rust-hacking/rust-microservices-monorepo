...
Migration:
sqlx migrate add -r create_users_table --source ./crates/jd_infra/migrations/
sqlx migrate run --source ./crates/jd_infra/migrations/ --database-url postgres://postgres:password@localhost:5444/postgres
sqlx migrate info --source ./crates/jd_infra/migrations/ --database-url postgres://postgres:password@localhost:5444/postgres
sqlx migrate revert --source ./crates/jd_infra/migrations/ --database-url postgres://postgres:password@localhost:5444/postgres
